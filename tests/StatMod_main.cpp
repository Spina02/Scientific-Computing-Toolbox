#include "../include/Stats_Module/ImportCSV.hpp"
#include "../include/Stats_Module/Utils.hpp"
#include "../include/Stats_Module/Stats.hpp"

#include "../include/Stats_Module/getpot-c++/GetPot"
#include <iostream>
#include <filesystem>
...
int main(int argc, char** argv) {
    ...
    std::string inputFile = cmdline.follow("data.csv", "-i");
    std::string outputFile = cmdline.follow("output.txt", "-o");
    std::string targetColumn = cmdline.follow("", "-c");
